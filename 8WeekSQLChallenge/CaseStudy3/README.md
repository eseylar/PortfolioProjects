*From Danny Ma's [8 Week SQL Challenge - Case Study #3](https://8weeksqlchallenge.com/case-study-3/)*

![Case Study #3 - Foodie-Fi](https://8weeksqlchallenge.com/images/case-study-designs/3.png)
...
Each of these questions can be answered with a single SQL query:
